...
module Background_drawer(
    ...
    input wire clk,
    input wire reset,
    input wire [4:0] hcount,
    input wire [10:0] vcount,
    input wire [26:0] reg_in,
...
wire [10:0] bg_type;
wire [9:0] y_pos;
wire [4:0] addressh, address0, address1, address2, address3, address4, address5, address6, address7;
...
initial $readmemh("../../../textures_data/trawa.data", romt);
initial $readmemh("../../../textures_data/woda.data", romw);
initial $readmemh("../../../textures_data/asfalt.data", roma);
...
always @* begin
  if (vcountd < lane0_buff[9:0])
    case(lane0_buff[20:10])
        ...
        11'h2  : nxt_pixel = roma[{address0,addressh}]; // 0x2 -> highway
        11'h3  : nxt_pixel = romw[{address0,addressh}]; // 0x3 -> water
    ...
    case(lane1_buff[20:10])
      ...
      11'h2  : nxt_pixel = roma[{address1,addressh}]; // 0x2 -> highway
      11'h3  : nxt_pixel = romw[{address1,addressh}]; // 0x3 -> water
      11'h4  : nxt_pixel = 12'h777; // 0x4 -> trainway
      default : nxt_pixel = 12'hF0F;
   endcase
    ...
    case(lane2_buff[20:10])
      ...
      11'h2  : nxt_pixel = roma[{address2,addressh}]; // 0x2 -> highway
      11'h3  : nxt_pixel = romw[{address2,addressh}]; // 0x3 -> water
      11'h4  : nxt_pixel = 12'h777; // 0x4 -> trainway
      default : nxt_pixel = 12'hF0F;
   endcase
    ...
    case(lane3_buff[20:10])
      ...
      11'h2  : nxt_pixel = roma[{address3,addressh}]; // 0x2 -> highway
      11'h3  : nxt_pixel = romw[{address3,addressh}]; // 0x3 -> water
      11'h4  : nxt_pixel = 12'h777; // 0x4 -> trainway
      default : nxt_pixel = 12'hF0F;
   endcase
    ...
    case(lane4_buff[20:10])
      ...
      11'h2  : nxt_pixel = roma[{address4,addressh}]; // 0x2 -> highway
      11'h3  : nxt_pixel = romw[{address4,addressh}]; // 0x3 -> water
      11'h4  : nxt_pixel = 12'h777; // 0x4 -> trainway
      default : nxt_pixel = 12'hF0F;
   endcase
    ...
    case(lane5_buff[20:10])
      ...
      11'h2  : nxt_pixel = roma[{address5,addressh}]; // 0x2 -> highway
      11'h3  : nxt_pixel = romw[{address5,addressh}]; // 0x3 -> water
      11'h4  : nxt_pixel = 12'h777; // 0x4 -> trainway
      default : nxt_pixel = 12'hF0F;
   endcase
    ...
    case(lane6_buff[20:10])
      ...
      11'h2  : nxt_pixel = roma[{address6,addressh}]; // 0x2 -> highway
      11'h3  : nxt_pixel = romw[{address6,addressh}]; // 0x3 -> water
      11'h4  : nxt_pixel = 12'h777; // 0x4 -> trainway
      default : nxt_pixel = 12'hF0F;
   endcase
    ...
    case(lane7_buff[20:10])
      ...
      11'h2  : nxt_pixel = roma[{address7,addressh}]; // 0x2 -> highway
      11'h3  : nxt_pixel = romw[{address7,addressh}]; // 0x3 -> water
      11'h4  : nxt_pixel = 12'h777; // 0x4 -> trainway
      default : nxt_pixel = 12'hF0F;
   endcase

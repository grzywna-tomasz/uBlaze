...
wire [10:0] bg_type;
wire [9:0] y_pos;
wire [6:0] addressh, address0, address1, address2, address3, address4, address5, address6, address7;
...
reg [11:0] rgb0t, rgb1t, rgb2t, rgb3t, rgb4t, rgb5t, rgb6t, rgb7t;

assign addressh = hcount%100;
assign address0 = vcount - lane1_buff[9:0];
...
always @* begin
  if (vcountd < lane0_buff[9:0])
    case(lane0_buff[20:10])
        11'h1  : nxt_pixel = rgb0t;// 0x1 -> grass
    ...
    case(lane1_buff[20:10])
      11'h1  : nxt_pixel = rgb1t;// 0x1 -> grass
      11'h2  : nxt_pixel = 12'h222; // 0x2 -> highway
      11'h3  : nxt_pixel = 12'h059; // 0x3 -> water
      11'h4  : nxt_pixel = 12'h777; // 0x4 -> trainway
      default : nxt_pixel = 12'hF0F;
   endcase
    ...
    case(lane2_buff[20:10])
      11'h1  : nxt_pixel = rgb2t;// 0x1 -> grass
      11'h2  : nxt_pixel = 12'h222; // 0x2 -> highway
      11'h3  : nxt_pixel = 12'h059; // 0x3 -> water
      11'h4  : nxt_pixel = 12'h777; // 0x4 -> trainway
      default : nxt_pixel = 12'hF0F;
   endcase
    ...
    case(lane3_buff[20:10])
      11'h1  : nxt_pixel = rgb3t;// 0x1 -> grass
      11'h2  : nxt_pixel = 12'h222; // 0x2 -> highway
      11'h3  : nxt_pixel = 12'h059; // 0x3 -> water
      11'h4  : nxt_pixel = 12'h777; // 0x4 -> trainway
      default : nxt_pixel = 12'hF0F;
   endcase
    ...
    case(lane4_buff[20:10])
      11'h1  : nxt_pixel = rgb4t;// 0x1 -> grass
      11'h2  : nxt_pixel = 12'h222; // 0x2 -> highway
      11'h3  : nxt_pixel = 12'h059; // 0x3 -> water
      11'h4  : nxt_pixel = 12'h777; // 0x4 -> trainway
      default : nxt_pixel = 12'hF0F;
   endcase
    ...
    case(lane5_buff[20:10])
      11'h1  : nxt_pixel = rgb5t;// 0x1 -> grass
      11'h2  : nxt_pixel = 12'h222; // 0x2 -> highway
      11'h3  : nxt_pixel = 12'h059; // 0x3 -> water
      11'h4  : nxt_pixel = 12'h777; // 0x4 -> trainway
      default : nxt_pixel = 12'hF0F;
   endcase
    ...
    case(lane6_buff[20:10])
      11'h1  : nxt_pixel = rgb6t;// 0x1 -> grass
      11'h2  : nxt_pixel = 12'h222; // 0x2 -> highway
      11'h3  : nxt_pixel = 12'h059; // 0x3 -> water
      11'h4  : nxt_pixel = 12'h777; // 0x4 -> trainway
      default : nxt_pixel = 12'hF0F;
   endcase
    ...
    case(lane7_buff[20:10])
      11'h1  : nxt_pixel = rgb7t;// 0x1 -> grass
      11'h2  : nxt_pixel = 12'h222; // 0x2 -> highway
      11'h3  : nxt_pixel = 12'h059; // 0x3 -> water
      11'h4  : nxt_pixel = 12'h777; // 0x4 -> trainway
      default : nxt_pixel = 12'hF0F;

...
// 
// Create Date: 06.08.2019 14:54:20
// Design Name: 
// Module Name: Truck_drawer
//////////////////////////////////////////////////////////////////////////////////
...
module Truck_drawer(
  ...
  assign address1[6:0] = hcount - obj_buff1[20:10] - WIDTH;
  assign address1[12:7] = vcount - obj_buff1[9:0] - HEIGHT;
  assign address1b[6:0] = obj_buff1[20:10] - hcount;

  assign address2[6:0] = hcount - obj_buff2[20:10] - WIDTH;
  assign address2[12:7] = vcount - obj_buff2[9:0] - HEIGHT;
  assign address2b[6:0] = obj_buff2[20:10] - hcount;

  assign address3[6:0] = hcount - obj_buff3[20:10] - WIDTH;
  assign address3[12:7] = vcount - obj_buff3[9:0] - HEIGHT;
  assign address3b[6:0] = obj_buff3[20:10] - hcount;
  
  assign address4[6:0] = hcount - obj_buff4[20:10] - WIDTH;
  assign address4[12:7] = vcount - obj_buff4[9:0] - HEIGHT;
  assign address4b[6:0] = obj_buff4[20:10] - hcount;
  
  assign address5[6:0] = hcount - obj_buff5[20:10] - WIDTH;
  assign address5[12:7] = vcount - obj_buff5[9:0] - HEIGHT;
  assign address5b[6:0] = obj_buff5[20:10] - hcount;
  
  assign address6[6:0] = hcount - obj_buff6[20:10] - WIDTH;
  assign address6[12:7] = vcount - obj_buff6[9:0] - HEIGHT;
  assign address6b[6:0] = obj_buff6[20:10] - hcount;
  
  assign address7[6:0] = hcount - obj_buff7[20:10] - WIDTH;
  assign address7[12:7] = vcount - obj_buff7[9:0] - HEIGHT;
  assign address7b[6:0] = obj_buff7[20:10] - hcount;
  
  assign address8[6:0] = hcount - obj_buff8[20:10] - WIDTH;
  assign address8[12:7] = vcount - obj_buff8[9:0] - HEIGHT;
  assign address8b[6:0] = obj_buff8[20:10] - hcount;
  
  assign address9[6:0] = hcount - obj_buff9[20:10] - WIDTH;
  assign address9[12:7] = vcount - obj_buff9[9:0] - HEIGHT;
  assign address9b[6:0] = obj_buff9[20:10] - hcount;
  
  assign address10[6:0] = hcount - obj_buff10[20:10] - WIDTH;
  assign address10[12:7] = vcount - obj_buff10[9:0] - HEIGHT;
  assign address10b[6:0] = obj_buff10[20:10] - hcount;
  
  initial $readmemh("../../../textures_data/truck.data", rom);
  ...
  always @* begin
      if(
        ...
        begin
          ...
          else nxt_pixel = 12'h23c;
        end
        else
        begin
            if (rom[{address1[12:7],address1b[6:0]}] != 12'hFFF)
                nxt_pixel = rom[{address1[12:7],address1b[6:0]}];
            else nxt_pixel = 12'h23c;
        end
        end
      else if(
        ...
        begin
              ...
              begin
                ...
                else nxt_pixel = 12'ha86;
              end
              else
              begin
                  if (rom[{address2[12:7],address2b[6:0]}] != 12'hFFF)
                      nxt_pixel = rom[{address2[12:7],address2b[6:0]}];
                  else nxt_pixel = 12'ha86;
              end
              end
      else if(
        ...
        begin
            ...
            begin
              ...
              else nxt_pixel = 12'h533;
            end
            else
            begin
                if (rom[{address3[12:7],address3b[6:0]}] != 12'hFFF)
                    nxt_pixel = rom[{address3[12:7],address3b[6:0]}];
                else nxt_pixel = 12'h533;
            end
            end
      else if(
        ...
        begin
          ...
          begin
            ...
            else nxt_pixel = 12'hc53;
          end
          else
          begin
              if (rom[{address4[12:7],address4b[6:0]}] != 12'hFFF)
                  nxt_pixel = rom[{address4[12:7],address4b[6:0]}];
              else nxt_pixel = 12'hc53;
          end
          end
      else if(
        ...
        begin
          ...
          begin
            ...
            else nxt_pixel = 12'h850;
          end
          else
          begin
              if (rom[{address5[12:7],address5b[6:0]}] != 12'hFFF)
                  nxt_pixel = rom[{address5[12:7],address5b[6:0]}];
              else nxt_pixel = 12'h850;
          end
          end
      else if(
        ...
        begin
            ...
            begin
              ...
              else nxt_pixel = 12'h205;
            end
            else
            begin
                if (rom[{address6[12:7],address6b[6:0]}] != 12'hFFF)
                    nxt_pixel = rom[{address6[12:7],address6b[6:0]}];
                else nxt_pixel = 12'h205;
            end
            end
      else if(
        ...
        begin
          ...
          begin
            ...
            else nxt_pixel = 12'h810;
          end
          else
          begin
              if (rom[{address7[12:7],address7b[6:0]}] != 12'hFFF)
                  nxt_pixel = rom[{address7[12:7],address7b[6:0]}];
              else nxt_pixel = 12'h810;
          end
          end
      else if(
        ...
        begin
          ...
          begin
            ...
            else nxt_pixel = 12'h46c;
          end
          else
          begin
              if (rom[{address8[12:7],address8b[6:0]}] != 12'hFFF)
                  nxt_pixel = rom[{address8[12:7],address8b[6:0]}];
              else nxt_pixel = 12'h46c;
          end
          end
          else if(
        ...
        begin
          ...
          begin
            ...
            else nxt_pixel = 12'hf31;
          end
          else
          begin
              if (rom[{address9[12:7],address9b[6:0]}] != 12'hFFF)
                  nxt_pixel = rom[{address9[12:7],address9b[6:0]}];
              else nxt_pixel = 12'hf31;
          end
          end
      else if(
        ...
        begin
          ...
          else nxt_pixel = 12'hd60;
        end
        else
        begin
            if (rom[{address10[12:7],address10b[6:0]}] != 12'hFFF)
                nxt_pixel = rom[{address10[12:7],address10b[6:0]}];
            else nxt_pixel = 12'hd60;
        end
        end
      else
